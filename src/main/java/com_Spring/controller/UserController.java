...
import com_Spring.service.UserService;
...
public class UserController  {
 ...
 public ModelAndView list(){
  ...
  List userlist= userService.listAllUsers();
 ...
 public ModelAndView add(){
  ...
  model.addObject("userForm", userAdd);
 ...
 public ModelAndView update(@PathVariable("id") int id){
  ...
  model.addObject("userForm", userupdate);
